                ...
                {post.audio_url && !post.metadata.hideAudio && (
                    <div className="mt-4">
                        ...
                        <span className="text-xs text-muted-foreground">
                            Note: This audio is generated by a text-to-speech model and may not be 100% accurate, I'm also currently playing around with it, so it may include a bit of data that shouldn't be included.
                        </span>
                    </div>
                )}
            </Suspense>
